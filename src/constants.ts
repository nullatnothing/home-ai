...
export const DEFAULT_SERVER_URL = "http://192.168.88.13:11434";
export const DEFAULT_MODELS: string[] = [];
export const LANGUAGE_OPTIONS: Language[] = ["en", "de", "es", "it", "fr"];
...
export const translations: Record<Language, TranslationStrings> = {
  en: {
    ...
    settings: "Settings",
    newChat: "New chat",
    messagePlaceholder: "Ask Samy...",
    send: "Send",
    sendLoading: "...",
    welcomeMessage: "Hi! I'm Samy. Ask me anything.",
    ...
    noAiServerConfiguredMessage:
      "Please set your Ollama URL in Settings first.",
    noConnectionTestYet: "No connection test yet",
    copyTextTitle: "Copy text",
    copyTextMessage: "Copy this message to the clipboard?",
    deleteChatTitle: "Delete chat",
    deleteChatMessage: "Delete this chat? This action cannot be undone.",
    delete: "Delete",
    copyAction: "Copy",
  ...
  de: {
    ...
    messagePlaceholder: "Frag Samy...",
    send: "Senden",
    sendLoading: "...",
    welcomeMessage: "Hallo! Ich bin Samy. Frag mich einfach etwas.",
    ...
    noAiServerConfiguredMessage:
      "Bitte richte deine Ollama-URL in den Einstellungen ein.",
    ...
    deleteChatMessage: "Diesen Chat löschen? Diese Aktion kann nicht rückgängig gemacht werden.",
    delete: "Löschen",
    copyAction: "Kopieren",
  ...
  es: {
    ...
    newChat: "Nuevo chat",
    messagePlaceholder: "Pregunta a Samy...",
    send: "Enviar",
    sendLoading: "...",
    welcomeMessage: "¡Hola! Soy Samy. Pregúntame lo que quieras.",
    ...
    noAiServerConfiguredMessage:
      "Configura la URL de Ollama en Configuración primero.",
    ...
    deleteChatMessage: "¿Eliminar este chat? Esta acción no se puede deshacer.",
    delete: "Eliminar",
    copyAction: "Copiar",
  ...
  it: {
    ...
    newChat: "Nuova chat",
    messagePlaceholder: "Chiedi a Samy...",
    send: "Invia",
    sendLoading: "...",
    welcomeMessage: "Ciao! Sono Samy. Chiedimi qualsiasi cosa.",
    ...
    noAiServerConfiguredMessage:
      "Imposta l’URL Ollama nelle Impostazioni prima.",
    ...
    deleteChatMessage: "Eliminare questa chat? Questa azione non può essere annullata.",
    delete: "Elimina",
    copyAction: "Copia",
  ...
  fr: {
    ...
    messagePlaceholder: "Demande à Samy...",
    send: "Envoyer",
    sendLoading: "...",
    welcomeMessage: "Salut ! Je suis Samy. Demande-moi ce que tu veux.",
    ...
    noAiServerConfiguredMessage:
      "Veuillez définir l’URL Ollama dans les réglages.",
    ...
    deleteChatMessage: "Supprimer ce chat ? Cette action est irréversible.",
    delete: "Supprimer",
    copyAction: "Copier",

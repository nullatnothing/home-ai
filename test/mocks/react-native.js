...
const host = (tag) => ({ children, ...props }) => React.createElement(tag, props, children);
...
module.exports = {
  ...
  View: host('View'),
  Text: host('Text'),
  TextInput: ({ value, onChangeText, ...props }) => React.createElement('TextInput', { value, onChangeText, ...props }),
